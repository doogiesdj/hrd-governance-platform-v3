...
> Phase 0-3 결과물 · 작성일: 2026-04-24 · 분석 대상: src/HRD_Governance_Extended_v2.rdf
...
### 확인 방법
```bash
grep -n "{http:/" src/HRD_Governance_Extended_v2.rdf | head -20
```
...
sed -i 's/{http:\/www.w3.org\/2001\/XMLSchema#}/http:\/\/www.w3.org\/2001\/XMLSchema#/g' \
  src/HRD_Governance_Extended_v2.rdf
```

> ⚠️ 수정 전 반드시 백업: `cp src/HRD_Governance_Extended_v2.rdf src/HRD_Governance_Extended_v2.rdf.bak`
...
- [ ] Protégé 5.x에서 `src/HRD_Governance_Extended_v2.rdf` 열기
